...
async function main() {
  ...
  {
    freshScratch();
    // The window has to outlast three journal fsyncs, or the deadline is already
    // in the past by the time it is scheduled and the pallet closes on the spot —
    // which looked like "quiet gaps close the pallet" on any slow disk.
