...
try {
  ...
  const exception = {
    ...
    palletCode: null,
    eventId: 'test-gate:g1:66',
    unexpected: 'no-open-batch',
    basis: 'not-on-open-batch',
    timestamp: new Date().toISOString(),
  };

  const boardApi = {
    board: { docs: [], pool: [], exceptions: [], counted: [], pending: [] },
    lastCounted: null,
    dupMsg: null,
    addFromPool() {},
    clearExceptions() {},
  ...
  const gateHtml = renderToStaticMarkup(React.createElement(GateBoard, {
    board: boardApi,
    entries: [exception],
    sound: 'ready',
    onOpenControls() {},
  ...
  const bridge = {
    ...
    rows: [], udpFrames: [], entries: [exception], gpi: { gpi1: null, gpi2: null, raw: '' },
    totalReads: 3, uniqueEpcs: 1, readsPerSec: 0, lastTriggerAt: 0,
    passageComplete: null, receivingResetAt: null, palletWorkflow: null, movement: null,
    clear() {},
  };
